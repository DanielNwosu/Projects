...
def update_hand(hand, word):
    ...
    for i in word:
        if updated_hand.get(i,0) > 0:
            updated_hand[i] -= 1
        if updated_hand.get(i,-1) == 0:
            del(updated_hand[i])
...
def is_valid_word(word, hand, word_list):
    ...
    if '*' in words_list:
        spot = words_list.index('*')
        for i in VOWELS:
            words_list[spot] = i
            words.append("".join(words_list))
    else:
        words.append(word)
...
def play_hand(hand, word_list):
    ...
    * The hand finishes when there are no more unused letters.
    ...
    while calculate_handlen(hand) > 0:
        ...
        display_hand(hand)
        # Ask user for input
        word = input("Enter word, or '!!' to indicate that you're done: ")
        ...
        # Otherwise (the input is not two exclamation points):
            ...
            # Otherwise (the word is not valid):
                ...
                print("That is not a valid word. Pick another")
   ...
   # print("play_game not implemented.") # TO DO... Remove this line when you implement this function
    ...
    for i in range(total_hands):
        ...
        if not letter_subbed:
            print("Current hand: ", end=' ')
            display_hand(hand)
            sub = input("Would you like to subsitute a letter?(yes/no)")
            if sub.lower() == 'yes':
                letter_subbed = True
